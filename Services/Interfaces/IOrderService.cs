...
public interface IOrderService
{
  ...
  Task<PromoCodeResponse> CalculateDiscountAsync(string promoCodes, decimal itemsTotal, decimal shippingFee, int branchID, int? userId = null);
  ...
  Task<(bool Success, string Message)> MarkOrderAsDelivered(int orderId);
  Task<(bool Success, string Message)> UpdateOrderStatusAsync(int orderId, string newStatus, string? shipperId = null);
}
